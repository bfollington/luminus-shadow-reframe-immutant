...
The `home-routes` handler in the `luminus-shadow-reframe-immutant.routes.home` namespace
...
The `home-page` function will in turn call the `luminus-shadow-reframe-immutant.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/luminus_shadow_reframe_immutant/core.cljs` file.



<p class="title is-5">Organizing the routes</p>

The routes are aggregated and wrapped with middleware in the `luminus-shadow-reframe-immutant.handler` namespace:
...
Request middleware functions are located under the `luminus-shadow-reframe-immutant.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `luminus-shadow-reframe-immutant.dev-middleware` namespace found in
